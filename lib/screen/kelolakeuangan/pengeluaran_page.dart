...
class PengeluaranPage extends StatefulWidget {
  String startDate;
  String endDate;
  PengeluaranPage({Key key, @required this.startDate, @required this.endDate})
      : super(key: key);
  @override
...
class _PengeluaranPageState extends State<PengeluaranPage> {
  ...
  Widget build(BuildContext context) {
    return new FutureBuilder<List<Transaksi>>(
      future: TransaksiController(context).getTransaksiByKategori(
          "Pengeluaran", widget.startDate, widget.endDate),
